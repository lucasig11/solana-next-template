...
export default function Home() {
  ...
  return (
    <main className="m-auto flex w-1/3 flex-col items-center space-y-10 p-10">
      <a
      ...
      >
        <button className="flex w-full items-center justify-center gap-2 text-xl text-sky-100">
        ...
        <Disclosure>
          {({ open }) => (
            <>
              ...
              <Disclosure.Panel className="w-full rounded-lg  bg-white px-4 pb-2 pt-4 text-sm text-gray-800">
                <p>Next.js</p>
                <p>@solana/web3.js</p>
      ...
      <div className="flex w-full flex-col items-center space-y-2">
        ...
        <NftSelect
          ...
          disabled={loading}
        />
        <span className="text-bold mr-auto text-sm">

...
export default function Home() {
  ...
  return (
    <main className="m-auto flex w-full flex-col items-center space-y-10 py-10 xl:w-1/2">
      <a
        ...
        <NftSelect
          ...
          text={
            loading
              ...
              : connected
              ? "Select NFTs..."
              : "Connect wallet to select NFTs"
          }
          nfts={nfts}
          value={selectedNfts}
          onChange={setSelectedNfts}
          disabled={!connected || loading || nfts.length === 0}
        />
      </div>
    </main>
  );
